  ...
  return (
    <main className="mx-auto max-w-5xl px-4 py-8">
      ...
      <section className="mx-auto max-w-2xl text-center">
        ...
        <h1
          className="animate-fade-up mt-4 text-balance text-4xl font-bold tracking-tight text-slate-900 sm:text-5xl"
          style={{ animationDelay: "0.05s" }}
        >
          {t.landing.heroTitle}
        </h1>
        <p
          className="animate-fade-up mx-auto mt-4 max-w-xl text-pretty text-slate-600"
        ...
        <div
          className="animate-fade-up mx-auto mt-10 flex max-w-3xl flex-wrap items-center justify-center gap-2"
        ...
        <div
          className="animate-fade-up mx-auto mt-12 max-w-3xl rounded-2xl border border-slate-200 bg-white/70 p-6 text-left shadow-sm"
